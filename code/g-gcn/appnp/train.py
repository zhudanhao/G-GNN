...
def main(args):
    ...
    ##
    structure_features = np.load('../../pretrained/'+args.dataset+'_structure_32d.npy')
    attr_features = np.load('../../pretrained/'+args.dataset+'_attr_32d.npy')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--galpha", type=float, default=0.001,
                        help="Weight for alpha in g-gnn")
    parser.add_argument("--gbeta", type=float, default=0.004,
                        help="Weight for beta in g-gnn")
